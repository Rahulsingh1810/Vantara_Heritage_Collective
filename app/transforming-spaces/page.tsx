...
export default function TransformingSpaces() {
  return (
    <main>
      {/* Hero Section */}
      <section className="bg-gradient-to-r from-primary/90 to-accent/80 text-primary-foreground py-16 md:py-24">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h1 className="text-4xl md:text-5xl font-bold mb-6 text-balance">Transforming Spaces with Heritage</h1>
      ...
      <section className="py-16 md:py-24 bg-background">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-3xl font-bold mb-12 text-balance">Room Inspirations</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-12">
            ...
            <Card className="overflow-hidden">
              ...
              <div className="p-6">
                <h3 className="text-2xl font-bold mb-3">Living Room Elegance</h3>
            ...
            <Card className="overflow-hidden">
              ...
              <div className="p-6">
                <h3 className="text-2xl font-bold mb-3">Peaceful Bedroom Retreat</h3>
                <p className="text-muted-foreground mb-4">
            ...
            <Card className="overflow-hidden">
              ...
              <div className="p-6">
                <h3 className="text-2xl font-bold mb-3">Inspiring Home Office</h3>
                <p className="text-muted-foreground mb-4">
            ...
            <Card className="overflow-hidden">
              ...
              <div className="p-6">
                <h3 className="text-2xl font-bold mb-3">Welcoming Entryway</h3>
                <p className="text-muted-foreground mb-4">
      ...
      <section className="py-16 md:py-24 bg-muted/30">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-3xl font-bold mb-12 text-center">Design Tips for Heritage Pieces</h2>

          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <Card>
              <CardContent className="p-6">
                <h3 className="text-xl font-bold mb-3">1. Balance Modern & Traditional</h3>
            ...
            <Card>
              <CardContent className="p-6">
                <h3 className="text-xl font-bold mb-3">2. Create Focal Points</h3>
                <p className="text-muted-foreground">
            ...
            <Card>
              <CardContent className="p-6">
                <h3 className="text-xl font-bold mb-3">3. Respect Color Palettes</h3>
                <p className="text-muted-foreground">
            ...
            <Card>
              <CardContent className="p-6">
                <h3 className="text-xl font-bold mb-3">4. Tell a Story</h3>
                <p className="text-muted-foreground">
            ...
            <Card>
              <CardContent className="p-6">
                <h3 className="text-xl font-bold mb-3">5. Layer Your Decor</h3>
                <p className="text-muted-foreground">
            ...
            <Card>
              <CardContent className="p-6">
                <h3 className="text-xl font-bold mb-3">6. Light It Well</h3>
                <p className="text-muted-foreground">
