...
import fetchSignatureProducts from '@/utils/queries/signature-pieces'

export const dynamic = 'force-static'

export const metadata: Metadata = {
  title: 'Signature Pieces - Vadānya Heritage Collective',
  description: 'Browse our collection of traditional artifacts and heritage pieces from artisans worldwide.'
}

export default async function SignaturePieces() {
  let products: any[] = []
  try {
    products = await fetchSignatureProducts()
  } catch (e) {
    products = []
    ...
    <main>
      ...
      <section className="bg-(--color-wine-red) py-12 text-(--color-ivory) md:py-16">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <h1 className="text-center text-4xl font-bold md:text-5xl">Our Signature Pieces</h1>
