        ...
        <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8">
          <div className="space-y-16">
            ...
            <div className="space-y-10">
              <h2 className="text-center text-3xl font-bold text-[var(--color-wine-red)]/90 md:text-left">
              ...
              <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
                ...
                <Card className="border-border bg-background shadow-sm transition-all hover:shadow-md">
                  <CardContent className="p-6">
                    <h3 className="mb-3 text-lg font-semibold text-[var(--color-wine-red)]/80">Curating with Intent</h3>
                    <p className="text-muted-foreground leading-relaxed">
            ...
            <div className="from-primary/5 to-accent/5 border-border rounded-xl border bg-gradient-to-br p-8 md:p-10">
              <h2 className="mb-6 text-3xl font-bold text-[var(--color-wine-red)]">A Note from the Collective</h2>
              ...
              <p className="text-right font-semibold text-[var(--color-wine-red)]/90">— Vadānya Heritage Collective</p>
            </div>

            {/* Environmental & Social Commitment – Blended */}
            <div className="space-y-10">
              <h2 className="text-center text-3xl font-bold text-[var(--color-wine-red)] md:text-left">
              ...
              <div className="grid grid-cols-1 gap-6 md:grid-cols-2 lg:gap-10">
                <div className="border-border bg-muted/30 space-y-6 rounded-xl border p-7">
                  <h3 className="text-xl font-semibold text-[var(--color-wine-red)]/80">
                    Respect for Regional Craft Ecosystems
                  </h3>
                  <ul className="space-y-4">
                    <li className="flex items-start gap-3">
                      <span className="mt-1 text-xl font-bold text-[var(--color-wine-red)]">✓</span>
                      <span>
                    ...
                    <li className="flex items-start gap-3">
                      <span className="mt-1 text-xl font-bold text-[var(--color-wine-red)]">✓</span>
                      <span>Partnerships respect the natural rhythm and capacity of each craft community</span>
                    </li>
                  </ul>
                </div>
                ...
                <div className="border-border bg-muted/30 space-y-6 rounded-xl border p-7">
                  ...
                  <ul className="space-y-4">
                    <li className="flex items-start gap-3">
                      <span className="mt-1 text-xl font-bold text-[var(--color-wine-red)]">✓</span>
                      <span>Use of sustainable, traditionally appropriate materials wherever possible</span>
                    </li>
                    <li className="flex items-start gap-3">
                      <span className="mt-1 text-xl font-bold text-[var(--color-wine-red)]">✓</span>
                      <span>Minimal packaging — 100% recyclable or reusable whenever feasible</span>
                    </li>
                    <li className="flex items-start gap-3">
                      <span className="mt-1 text-xl font-bold text-[var(--color-wine-red)]">✓</span>
                      <span>
              ...
              <div className="mt-10 text-center md:text-left">
                <p className="text-lg font-medium text-[var(--color-wine-red)]/80 italic">
